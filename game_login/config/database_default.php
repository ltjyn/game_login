...
$active_record = TRUE;
$db = array();
$db['dbr']['hostname'] = '127.0.0.1';
$db['dbr']['username'] = 'root';
#$db['dbr']['password'] = 'w0npee';
$db['dbr']['password'] = '';
$db['dbr']['database']['log'] = 'data_server';
...
$db['dbw']['hostname'] = '127.0.0.1';
$db['dbw']['username'] = 'root';
$db['dbw']['password'] = '';
#$db['dbw']['password'] = 'w0npee';
$db['dbw']['database']['log'] = 'data_server';
